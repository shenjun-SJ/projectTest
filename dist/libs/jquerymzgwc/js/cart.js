...
if(gm.length==0){
    ...
    $(".mzContainer").css("display","none");
}else{
    $(".nothing").css("display","none");
    $(".mzContainer").css("display","block");
}
$.each(gm, function (i, e) {
    var newTr = '';
        ...
        newTr += '<tr index="'+ e.msg.goodId + '">\
                        <td class="goods-col-select">\
                            ...
                            <a href="javascript:;" class="goods-img">\
                                <img src="'+ e.msg.imgs.smallImg[0] + '"\
                                    alt="">\
                            </a>\
                            <a href="javascript:;" class="goods-info">\
                                <h4 class="goods-info-title">'+ e.msg.title + '</h4>\
                                <p class="goods-info-tips">'+ e.msg.content + '</p>\
                            </a>\
                        </td>\
                        <td class="goods-col-price">\
                            <span>￥'+ e.msg.price + '</span>\
                        </td>\
        ...
        floatDelBtn: function () {
            ...
            shopCart.delBtn.on("click", function () {
                ...
                if (shopCart.judge == "global") {
                    ...
                    var gm = JSON.parse(localStorage.getItem("goodsMsg"))
                    var id = $(".checked").parent().parent().attr("index");
                    gm.splice(id,1);
                    localStorage.setItem("goodsMsg",JSON.stringify(gm));
